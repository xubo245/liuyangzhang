...
if($action=="yz"){
	...
	VALUES (
	'$mid','$timestamp','$lfjdb[uid]','$lfjdb[username]','$postdb[yz]','$onlineip','$postdb[city_id]')");
...
elseif($action=="edit")
{
	...
	$db->query("UPDATE `{$_pre}person` SET city_id='$postdb[city_id]',posttime='$timestamp' WHERE id='$id'");
