...
function getpage($table,$choose,$url,$rows=20,$total=''){
	...
	$showpage="<a href=\"$url&page=1\" title=\"首页\" class=\"pb\">首页</A> <a href=\"$url&page=$uppage\" title=\"上一页\" class=\"up\">上一页</A>  {$show}  <a href=\"$url&page=$nextpage\" title=\"下一页\" class=\"next\">下一页</A> <a href=\"$url&page=$totalpage\" title=\"尾页\" class=\"pe\">尾页</A> <span><em>$page</em>/$totalpage/$total</span>";
    if($totalpage>1){
		return $showpage;
	}
}
