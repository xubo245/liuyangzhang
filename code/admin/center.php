...
elseif($job=="user_reg"&&($Apower[user_reg]||$Apower[center_config]))
{
	...
	$yzImgReg[intval($webdb[yzImgReg])]=" checked ";
	$yzNumReg[intval($webdb[yzNumReg])]=" checked ";
...
elseif($job=='GetOfficialNotice'){
	...
	}if( !@copy("http://$OfficialUrl1$OfficialUrl2/OfficialNotice.php?E=$qibosoft_Edition&upgrade_Record=$webdb[upgrade_Record]&U=$webdb[www_url]&T=QY",ROOT_PATH."cache/OfficialNotice.txt") )
	{
		if(!$OfficialNotice=file_get_contents("http://$OfficialUrl1$OfficialUrl2/OfficialNotice.php?E=$qibosoft_Edition&upgrade_Record=$webdb[upgrade_Record]&U=$webdb[www_url]&T=QY"))
		{
			$OfficialNotice=sockOpenUrl("http://$OfficialUrl1$OfficialUrl2/OfficialNotice.php?E=$qibosoft_Edition&upgrade_Record=$webdb[upgrade_Record]&U=$webdb[www_url]&T=QY");
		}
